...
const DICT = {
  fr: {
    ...
    'join.disconnected': 'Vous avez été déconnecté de la room.',
    'speaker.are-you': 'Vous êtes speaker ?',
    'speaker.login': 'Console speaker',
    'room.workshop': 'Atelier',
    'room.conference': 'Conférence',
    'room.seat': 'Place : R{row} · {block} · S{seat}',
    'room.pick-seat': 'Choisissez une place',
    'room.choose-location': 'Veuillez indiquer votre emplacement',
    'room.you': 'Vous : {pseudo}',
    'room.rename': 'Changer de pseudo',
    'room.refresh': 'Rafraîchir les données',
    ...
    'footer.powered': 'Propulsé par Vidocq',
    ...
    'chat.dm': 'Message privé',
    'chat.dm-empty': 'Démarrez une conversation privée avec les speakers.',
    'chat.dm-placeholder': 'Message privé aux speakers…',
    'chat.send': 'Envoyer',
  ...
  en: {
    ...
    'join.disconnected': 'You were disconnected from the room.',
    'speaker.are-you': 'Are you a speaker?',
    'speaker.login': 'Speaker console',
    'room.workshop': 'Workshop',
    'room.conference': 'Conference',
    'room.seat': 'Seat: R{row} · {block} · S{seat}',
    'room.pick-seat': 'Pick a seat',
    'room.choose-location': 'Please select your location',
    'room.you': 'You: {pseudo}',
    'room.rename': 'Change nickname',
    'room.refresh': 'Refresh data',
    ...
    'footer.powered': 'Powered by Vidocq',
    ...
    'chat.dm': 'Private message',
    'chat.dm-empty': 'Start a private conversation with the speakers.',
    'chat.dm-placeholder': 'Private message to the speakers…',
    'chat.send': 'Send',
