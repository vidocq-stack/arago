...
- [x] `/health` répond `UP` (knock) **et `/metrics` expose le compteur de rooms actives** : `@Gauge arago_active_rooms` (MP Metrics 5.1 via dirac, ARAGO-001) — OpenMetrics/Prometheus.
